...
const lookAheadItems: LookAhead[] = [
  ...
  },
  {
    ...
    text: "Get introduced to Amelia\u2019s main Zoom contact. He\u2019s ready \u2014 first formal step into the Zoom partnership relationship.",
  },
  {
...
const meetingData: DayData[] = [
  {
    ...
    meetings: [
      ...
      {
        title: "Daily Check-In \u2014 Mithun \u2194 Andrew & Amelia",
        summary:
          "Debrief on the Joe 1:1. Andrew: \u201cJoe\u2019s a hard nut to crack\u201d \u2014 pleasantly surprised. Prototype demo well received. Current Zoom API blocker: ~30 videos at a time; Andrew confirmed Zoom will build it when a big enough client pushes. Direction: go deeper on Zoom this week, shadow Kara on sales calls, show Alan the prototype. Amelia raised CRM integration vision \u2014 visualize how Zoom Events engagement data flows into Salesforce/HubSpot as a second prototype.",
      },
      {
  ...
  },
  {
    ...
    meetings: [
      ...
      {
        title: "Daily Check-In \u2014 Amelia + Mithun",
        summary:
