...
const themes: Theme[] = [
  ...
  },
  {
    ...
    text: "Joe built 12\u201313 meetings in minutes with Claude. Connor is automating Computershare spreadsheets with Cowork. Power BI templates are scaling. Emilia wants to run AI prompts against 7,000 target companies for prospecting. The appetite is real \u2014 the tooling and governance just need to catch up.",
  },
];
...
const meetingData: DayData[] = [
  ...
  },
  {
    ...
    meetings: [
      ...
      {
        title: "Emilia \u2014 Midweek Check-In",
        summary:
          "Strategic download. Tyler Brubach (her main Zoom contact) is ready for an SE intro whenever I am. Emilia reinforced that the Zoom partnership is her top priority and the SE role is critical to scaling it.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    meetings: [
      ...
      {
        title: "Sales Org Chart Teach-In \u2014 Emilia + Andrew",
        summary:
          "Full walkthrough of the sales org. Three teams: GCS, Institutional, and Zoom Partnership. Almost everyone on the institutional side came from the client side at banks. Emilia and Andrew co-lead sales. Action item: 1\u20132 salespeople per week for intro calls, start with Gib.",
      },
    ],
  },
];
